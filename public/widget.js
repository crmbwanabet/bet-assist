...
(function () {
  ...
  // ============================================
  const ICO = {
    ball: '<svg viewBox="0 0 100 130" xmlns="http://www.w3.org/2000/svg"><path d="M50 29 L50 16 L37 16" stroke="#1a1a1a" stroke-width="5.5" stroke-linecap="round" stroke-linejoin="round" fill="none"/><circle cx="35" cy="16" r="5" fill="#1a1a1a"/><rect x="25" y="30" width="50" height="40" rx="11" fill="none" stroke="#1a1a1a" stroke-width="6"/><rect x="14" y="45" width="13" height="7" rx="3.5" fill="#1a1a1a"/><rect x="73" y="45" width="13" height="7" rx="3.5" fill="#1a1a1a"/><rect x="35" y="41" width="10" height="9" rx="2.5" fill="#1a1a1a"/><rect x="55" y="41" width="10" height="9" rx="2.5" fill="#1a1a1a"/><text x="50" y="98" text-anchor="middle" fill="#1a1a1a" font-family="Arial,sans-serif" font-size="26" font-weight="700" letter-spacing="4">AI</text></svg>',
